...
class SubmissionController extends Controller
{
    ...
    {
        // Mengambil submission yang masih pending
        $pendingSubmissions = Submission::where('status', 'pending')->get();

        // Mengambil submission yang sudah diapprove atau direject
        $approvedRejectedSubmissions = Submission::where('status', '<>', 'pending')->get();
